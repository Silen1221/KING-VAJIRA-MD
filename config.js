const fs = require('fs-extra') 
 ...
 //═══════[Required Variables]════════\\ 
 global.owner = process.env.OWNER_NUMBER.split("0772173031,") 
 ...
 module.exports = { 
   botname:   process.env.BOT_NAME === undefined ? 'YAKA' : process.env.BOT_NAME, 
   ownername: process.env.OWNER_NAME === undefined ? '💥____💥Ya👹️Ka💥____💥' : process.env.OWNER_NAME,  
